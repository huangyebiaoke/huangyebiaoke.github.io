...
<img src="/assets/blogimg/itme_game_tiaotiaoball_ball.png">
<!--more-->
1.<a href="/itme/game/tiaotiaoball/settime">计时器：</a>
``` bash
<html>
<head>
...
```
2.<a href="/itme/game/tiaotiaoball/ball1">用canvas插入img：</a>
``` bash
<html>
<head>
	<title>ball</title>
...
```
3.<a href="/itme/game/tiaotiaoball/ball">跳跳球：</a>
``` bash
<html>
<head>
	<title>ball</title>
...
```
附：1.<a href="http://www.friendsofed.com/downloads.html">The Essential Guide to HTML5 <h6>using games to learn html5 and javascript</h6></a>